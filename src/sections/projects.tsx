...
export function Projects() {
  ...
  return (
    <section
      ref={ref}
      id="projects"
      className="relative bg-foreground text-background shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]"
    ...
    >
      <div className=" sticky top-0 flex h-screen flex-col overflow-hidden">
        <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col justify-between px-6 pb-6 pt-24 sm:flex-row sm:items-end sm:pb-8 sm:pt-28">
          <div aria-hidden className="absolute left-6 top-20 h-px w-[calc(100%-3rem)] bg-gradient-to-r from-background/5 via-background/20 to-background/5" />
          <div>
          ...
          >
            {projects.map((p, i) => (
              <motion.article
                ...
                className="group relative flex h-[62vh] w-[88vw] shrink-0 flex-col justify-end overflow-hidden rounded-[2rem] border border-background/10 p-6 shadow-[0_40px_120px_-80px_rgba(0,0,0,0.9)] sm:w-[65vw] md:w-[50vw] md:p-8 lg:w-[38vw]"
                style={{
              ...
              >
                ...
                <div className="absolute right-6 top-6 z-10 flex h-10 w-10 items-center justify-center rounded-full border border-background/20 bg-background/10 opacity-0 shadow-[0_16px_40px_-26px_rgba(255,255,255,0.8)] backdrop-blur transition-all group-hover:scale-110 group-hover:opacity-100">
            ...
            <motion.a
              ...
              viewport={{ once: true }}
              className="flex h-[62vh] w-[50vw] shrink-0 items-center justify-center rounded-[2rem] border border-background/10 bg-background/5 shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] transition-colors hover:bg-background/10 sm:w-[35vw] lg:w-[25vw]"
            >
